...
import com.cc.oem.common.utils.VerifyCodeUtils;
import com.google.code.kaptcha.Producer;
import com.cc.oem.modules.sys.dao.SysCaptchaDao;
import com.cc.oem.modules.sys.entity.SysCaptchaEntity;
...
public class SysCaptchaServiceImpl extends ServiceImpl<SysCaptchaDao, SysCaptchaEntity> implements SysCaptchaService {
    ...
    public void getCaptcha(String uuid,ServletOutputStream out) {
        ...
        //5分钟后过期
        captchaEntity.setExpireTime(DateUtils.addDateMinutes(new Date(), 2));
