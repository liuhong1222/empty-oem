...
public class DateUtils {
    ...
    public static CommonDateTimeData getCommonDateTime(){
        String today = format(new Date(), DateUtils.DATE_PATTERN);
        CommonDateTimeData data = new CommonDateTimeData();
        data.setStartTime(today+" 00:00:00");
        data.setEndTime(today+" 23:59:59");
        return data;
    }
